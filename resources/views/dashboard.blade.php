<x-app-layout>
    ...
    <section class="flex flex-wrap justify-between [&>div]:min-w-[280px]">
        ...
        <a href="{{ Auth::guard('teacher') ? '/notas/teacher' : '##' }}" class="bg-[#FFD14C] grid text-center flex-1 grow h-60 py-5">
            <div>
        ...
        <a href="{{ Auth::guard('teacher') ? '/notas/teacher' : '##' }}" class="bg-[#bababa] grid text-center flex-1 grow h-60 py-5">
            <div>
                <h1 class="text-5xl text-black font-semibold">Perfil</h1>
            </div>
            <div class=" w-full flex justify-center">
